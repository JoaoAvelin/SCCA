...
"background-color: rgb(186, 186, 186);")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Tela principal/Cadastro.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/Tela principal/Procurar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionProcurar.setIcon(icon1)
        self.actionProcurar.setObjectName("actionProcurar")
        self.actionRefresh = QtWidgets.QAction(MainWindow)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Tela principal/Refresh.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRefresh.setIcon(icon2)
        self.actionRefresh.setObjectName("actionRefresh")
        self.actionEditar = QtWidgets.QAction(MainWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/Tela principal/Editar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionEditar.setIcon(icon3)
        self.actionEditar.setObjectName("actionEditar")
        self.actionApagar = QtWidgets.QAction(MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Tela principal/Apagar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionApagar.setIcon(icon4)
